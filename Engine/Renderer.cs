...
public class Renderer
{
    ...
    public static string DefaultWavingShaderPath = "res://Content/Materials/new_shadermaterial.tres";

    public static SpatialMaterial DefaultMaterial;
    public static SpatialMaterial DefaultWavingShader;
    ...
    public static SpatialMaterial GetWavingShader {
        get {
            if(DefaultWavingShader is null)
                DefaultWavingShader = (SpatialMaterial)ResourceLoader.Load(DefaultMaterialPath);

            return DefaultWavingShader;
        }
    }
}
